...
namespace SimpleBicycleServicePack
{
    public class SimpleBicycleService: IBicycleService
    {
        private IBicycle _bicycle;
        private IRepositor<IBicycle> _repositor;

        public SimpleBicycleService(IBicycle bicycle, IRepositor<IBicycle> repositor)
        {
            _bicycle = bicycle;
